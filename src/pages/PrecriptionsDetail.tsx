...
//   const openModal = () => {
//     setIsModalOpen(true);
//     console.log('cccc',prescriptions);
//   };
...
//               <div className="w-full md:w-[50%] mx-auto flex flex-col md:flex-row mt-4">
                
//                 {activeItem === 'current' && <CurrentDetail item={item}  />}
//                 {activeItem === 'historical' && <HistoricalDetail item={item} />}
//                 {/* {activeItem === 'current' && <AddNewPrescription item={item} pre={prescriptions}/>} */}
//                 <AddNewPrescription pre={prescriptions} item={item}/>
//               </div>
...
//             {activeItem === 'current' && <FaCirclePlus size={55} className='text-primaryBlue cursor-pointer' onClick={openModal}/>}
