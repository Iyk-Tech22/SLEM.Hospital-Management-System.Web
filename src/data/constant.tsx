...
export interface IPatients {
  ...
  outstandingBillsStatus:BillingStatus,
  primaryContactName:string,
  primaryContactRelationship:string,
  secondaryContactName:string,
  secondaryContactRelationship:string,
  signedConsents:patientConsentStatus,
  pendingConsents:patientConsentStatus,
...
const Patients: IPatients[] = [
  {
    ...
    recentLabTests:'Blood Test (Normal)',
    historicalLabResults:'X-ray (Normal)',
    currentPrecription:'Ibuprofen (200mg - As needed)',
    precriptionHistory:'Amoxicillin (500mg - Twice a day)',
    vaccine:'COVID-19',
    vaccineDate:'2021-05-01',
    doctorNote:'Patient has shown improvement',
    nurseNote:'Vitals are stable',
    insuranceDetails:'HealthCare Inc. - HC123456',
    billingDate:'2023-01-01',
    billingAmount:150,
    billingStatus:BillingStatus.PAID,
    outstandingBillsDate:'2023-06-15',
    outstandingBillsAmount:150,
    outstandingBillsStatus:BillingStatus.PENDING,
    primaryContactName:'Jane Doe',
    primaryContactRelationship:'Wife',
    secondaryContactName:'Bob Smitt',
    secondaryContactRelationship:'Brother',
    signedConsents:patientConsentStatus.APPROVED,
    pendingConsents:patientConsentStatus.NONE,
